...
/*
   ...
   NOTE: when no press or press one key/button, the values on Serial Monitor may be NOT
   consistent, they may be slighly different => use a central value
*/
