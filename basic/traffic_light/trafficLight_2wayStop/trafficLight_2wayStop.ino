// trafficLight_2wayStop.ino
// check schematics folder for hardware

// https://someplacein.space/trafficlight/

// https://someplacein.space › trafficlight › TrafficLight_2WayStop.ino
// Someplace in Space
// Too large, the lights will strobe;
// too small, the lights will get dim
// Try tuning this to get the
// best visual results
// int cycleDelay = 10; 
