...
// pins of 4-digit 7-segment display attach to pin2-13 respectively 
int a = 7;
int b = 3;
int c = 4;
int d = 5;
...
long n = 0;     // n represents value displayed on LED. For example, when n=0, 0000 is displayed. The maximum value is 9999. 
int x = 100;
