...
void setup()
{
  ...
  display.setBrightness(0x0a);  // Set display brightness 
...
void loop()
{
  ...
  display.showNumberDec(displaytime, true);                           // Display current time in 24 hour format with leading zeros enabled and a center colon
}
