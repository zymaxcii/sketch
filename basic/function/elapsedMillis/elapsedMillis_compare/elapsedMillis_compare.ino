...
// Contains 3 functions to illustrate blinking an LED with 50% duty cycle
// 1. using delay()
// 2. using millis()
// 3. using elapsedmillis()
...
/*
  ...
  When you set an elapsedMillis variable to 0 (zero), 1
...
void delayloop()
{
  // any "real code" you put here will cause the time between blinks to grow
