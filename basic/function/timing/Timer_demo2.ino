...
void loop()
{
  ...
  else
  {
   if (digitalRead(button1Pin)==HIGH)
   {
    ...
    if (timeElapsed < 1000)
    {
      // if less than a second has elapsed turn first led on
        digitalWrite(led1Pin, HIGH);   // turn the LED on (HIGH is the voltage level)
    }
    
    if (timeElapsed > 1000 && timeElapsed <2000)
    {
      // if more than a second has passed and less than 2 turn led 1 off and turn led 2 on
    ...
    {
      // if more than a 2 seconds have passed and less than 3 turn led 2 off and turn led 3 on
    ...
    {
      // if more than a 3 seconds have passed and less than 4 turn led 3 off and turn led 4 on
    ...
    if (timeElapsed > 4000)
    {
      // if more than a 4 seconds have passed turn led 4 off and reset the timer to 0
