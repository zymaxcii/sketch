// potbSerialUpdater.ino
// POTB_SerialUpdater.pde
...
void potbSetup()
{
  pinMode(SWITCH_1, INPUT_PULLUP);          // sets the switch one pin to input
  // digitalWrite(SWITCH_1, HIGH);          // turns on the internal pull up resistor
                                            // this means it will read high when off and low when on 
  pinMode(SWITCH_2, INPUT_PULLUP);          // sets the switch one pin to input
  // digitalWrite(SWITCH_2, HIGH);          // turns on the internal pull up resistor
                                            // this means it will read high when off and low when on 
  pinMode(SWITCH_3, INPUT_PULLUP);          // sets the switch one pin to input
