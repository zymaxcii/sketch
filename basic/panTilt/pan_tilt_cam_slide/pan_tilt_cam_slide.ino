...
void setup() {
  ...
  // Adding the 3 steppers to the StepperControl instance for multi control
...
void loop()
{
  ...
  // Do nothing if limit switch pressed or distance traveled in other direction greater then 80cm
