...
// if Moisture Is Bigger Than - this value controls when to water your plant
int ifMoistureIsBiggerThan = 700;

int numberOfReadingsAboveTreshold = 0;

// this value controls how long plants should be watered
...
void loop()
{
  //to avoid any errors system will water flower only when 10 last readings 
  // will be smaller than ifMoistureIsBiggerThan value
