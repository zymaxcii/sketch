...
// 7 segment 4 digit shift register
// fail to compile: class Timer has no member named 'update'

#include "Timer.h"                        // include timer library

Timer t;                                  // craete a timer object
long number = 0;                          // declare variables
...
void loop()
{
  ...
  if (Serial.available())
  {
    ...
    String s = Serial.readString();                // read serial value
...
{
  // seperate input number into 4 single digits
