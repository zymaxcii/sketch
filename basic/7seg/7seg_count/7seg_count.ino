...
void on(byte num)
{
  int result = bitRead(num, 0);         // Read first binary entry in num and stores it in result
...
void loop()
{
  on(num0);                    // Passing “num0” to function “on()” defined above to display “0”
