...
// no ref website
// need first to figure out hardware setup
...
#define NUMBUTTONS ?      // replace "?"with number of buttons you are using
...
// first two numbers refer to the pins the encoder is connected to 
// second two are the buttons each click of the encoder wil press 
...
// joystick settings
Joystick_ Joystick(JOYSTICK_DEFAULT_REPORT_ID, JOYSTICK_TYPE_JOYSTICK, 32, // number of buttons
...
// change details to match the details above for each potentiometer you are using
